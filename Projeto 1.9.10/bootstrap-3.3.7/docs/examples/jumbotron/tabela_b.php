...
//Aqui está os echo's responsaveis por mostrar os dados ao usuário
    if ($dados['deposito'] == "B") {
      ...
      echo "<td>"."<a href='deletar_hist.php?id_item=".$dados['id_item']."&modelo=".$dados['modelo']."&descricao=".$dados['descricao']."&categoria=".$dados['categoria']."' class='btn btn-danger'>Deletar</a>"."</td>";
      echo "</tr>";
    }
  }
    ?>
