...
<head>
 ...
 <title>GercItens - Visualizar tabela</title>
...
//Aqui está os echo's responsaveis por mostrar os dados ao usuário
    if ($dados['deposito'] == "A") {
      ...
      echo "<td>"."<a href='deletar_hist.php?id_item=".$dados['id_item']."' class='btn btn-danger'>Deletar</a>"."</td>";
      echo "</tr>";
    }
  }
    ?>
...
<!-- Link responsável por levar ao cadastro -->
  <a class="btn btn-default" href="tabela.php" role="button">Ir Para Tabela Geral &raquo;</a> 
  <a class="btn btn-default" href="tabela_b.php" role="button">Ir Para Tabela do Depósito B &raquo;</a> <br><br>
        <center>
